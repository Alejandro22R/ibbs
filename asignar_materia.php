...
// Validar que el usuario esté logueado y sea admin, superadmin o docente/profesor
if (empty($_SESSION['loggedin']) || !in_array($_SESSION['rol'], ['superadmin', 'admin', 'docente', 'profesor'])) {
