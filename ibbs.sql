...
INSERT INTO `foro_mensajes` (`id`, `materia_id`, `usuario_nombre`, `rol`, `mensaje`, `respuesta_a`, `fecha`) VALUES
(1, 3, 'Enmanuel', 'superadmin', 'enmanuel', NULL, '2026-09-01 23:18:14'),
(2, 3, 'Enmanuel', 'superadmin', 'prueba', NULL, '2026-09-01 23:18:17'),
(3, 3, 'Enmanuel', 'superadmin', 'prueba', 2, '2026-09-01 23:18:25'),
(4, 3, 'Enmanuel', 'superadmin', 'ss', NULL, '2026-09-01 23:42:20'),
(5, 6, 'Enmanuel', 'superadmin', 'enmanuel', NULL, '2026-09-02 00:04:15'),
...
ALTER TABLE `entregas`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unica_entrega` (`tarea_id`,`alumno_id`),
  ADD KEY `alumno_id` (`alumno_id`);
...
ALTER TABLE `entregas`
  ...
  ADD CONSTRAINT `entregas_ibfk_2` FOREIGN KEY (`alumno_id`) REFERENCES `alumnos` (`id`) ON DELETE CASCADE;

--
-- Filtros para la tabla `foro_mensajes`
--
ALTER TABLE `foro_mensajes`
  ADD CONSTRAINT `foro_mensajes_ibfk_1` FOREIGN KEY (`respuesta_a`) REFERENCES `foro_mensajes` (`id`) ON DELETE CASCADE;
